        ...
        <nav className="container relative mx-auto p-4 flex justify-between items-center">
          ...
          <div className="justify-self-end relative">
            <button
              ...
              className="h-11 bg-white rounded-full border border-gray-200 text-sm pl-3 px-2 py-1 min-w-full flex justify-between items-center hover:shadow-md"
            >
              <img src="/icons/menu.svg" alt="Menu" className="w-5 h-5 mr-2" />
              <img src="/icons/user.svg" alt="User" className="w-5 h-5" />
            </button>
            {userMenu && (
              <ul className="bg-white rounded-xl border border-gray-200 p-3 top-0 right-0 transform translate-y-14 hover:shadow-md absolute w-40">
