const pets = [
    ...
    },
  {
   id: 9,
    ...
    weight: '2.1kg',
    color: 'Black',
    bio: `A sweet pup that enjoys playing and is learning into petting. Looking for a warm and steady house for a lifetime.`,
    ...
    },
  {
    ...
    weight: '2.3kg',
    color: 'Calico',
    bio: `Sweet and gives in to petting. A young pup that wants to find a house with a lot of toys and an owner that will always love.`,
    tagline: `1, 2, 3`,
    hypoallergenic: false,
    diet: 'Regular',
    breed: 'Mixed',
    ...
    },
  {
    ...
    bio: `Cute and friendly. A beautiful pup, that loves being pet and cuddled, wants to find a hugging and pampering owner.`,
    ...
    },
  {
    ...
    weight: '3kg',
    color: 'Tabby and White',
    bio: `Sweet and self indulging. A naughty pup thirsty for love and ready for her life goal - finding a committed owner that will give her a loving stable home.`,
    ...
    },
  {
    ...
    weight: '3kg',
    color: 'Black and White',
    bio: `Sweet and full of charm. A friendly pup, energetic and naughty. Wants to share her life with a charming and giving owner.`,
    ...
    },
  {
    ...
    weight: '3kg',
    color: 'Tabby and White',
    bio: `A curious and playful pup. Wants to give all her good vibes to the one that will take her into his loving and warm home.`,
    tagline: `One cat, infinite love`,
    hypoallergenic: false,
    diet: 'Regular',
    breed: 'Mixed',
